...
public class CallMemberWithArgumentCount3 : IOperationCode
{
    private readonly string _functionName;
    private const int ArgumentCount = 3;

    public CallMemberWithArgumentCount3(string functionName)
    {
