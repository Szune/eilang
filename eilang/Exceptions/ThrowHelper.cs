...
public static class ThrowHelper
{
    ...
    public static InvalidArgumentTypeException InvalidArgumentType(Function function, string parameterName, ValueBase value,
    ...
    public static InvalidArgumentTypeException InvalidArgumentType(string function, string parameterName, ValueBase value,
        List<ParameterType> types)
    {
        var allowedTypes = string.Join(" | ", types.Select(t => t.Name));
        var actualType = Types.GetTypeName(value);
    ...
    public static ListIndexOutOfRangeException ListIndexOutOfRange(string arrayName, int index, List<ValueBase> list)
    {
