...
public static class DirModule
{
    ...
    [ExportFunction("move")]
    public static ValueBase RenameDirectory(State state, Arguments args)
    {
    ...
    [ExportFunction("copy")]
    public static ValueBase CopyDirectory(State state, Arguments args)
    {
    ...
    [ExportFunction("make")]
    public static ValueBase MakeDirectory(State state, Arguments args)
    {
...
Console.WriteLine(ex.ToString());
    ...
    public static ValueBase DeleteDir(State state, Arguments args)
    {
