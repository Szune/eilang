...
namespace eilang.Modules
{
    ...
    public static class InteropModule
    {
        ...
        public static IValue CallFunction(State state, Arguments args)
        {
            ...
            var paramValues = argsList.Get<List<IValue>>(3);
        ...
        public static IValue Load(State state, Arguments args)
        {
        ...
        public static IValue Free(State state, Arguments args)
        {
        ...
        public static IValue GetExport(State state, Arguments args)
        {
        ...
        public static IValue InvokeLibrary(State state, Arguments args)
        {
            var argsList = args.List().With
            ...
            var paramValues = argsList.Get<List<IValue>>(2);
