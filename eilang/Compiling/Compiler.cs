...
public class Compiler : IVisitor
{
    ...
    public void Visit(AstIf aIf, Function function, Module mod)
    {
        ...
        var ifElseEndIndex = function.Code.Count;
        function[jmpfOpCodeIndex] = new Bytecode(OpFactory.JumpIfFalse(ValueFactory.Integer(ifElseEndIndex)),
            new Metadata {Ast = aIf});
    ...
    public void Visit(AstIndexerReference indexer, Function function, Module mod)
    {
        ...
        function.Write(OpFactory.Reference(indexer.Identifier), new Metadata {Ast = indexer});
        function.Write(OpFactory.TypeGet(), new Metadata {Ast = indexer});
        indexer.IndexExprs[0].Accept(this, function, mod);
        function.Write(OpFactory.CallMember("idx_get", argumentCount: 1),
    ...
    public void Visit(AstAssignment assignment, Function function, Module mod)
    {
        ...
        switch (assignment.Value.Type)
        {
            case Assignment.Equals:
                ...
                {
                    case AssignmentSet.Array:
                        function.Write(OpFactory.CallMember("idx_set", argumentCount: 2),
                            new Metadata {Ast = assignment});
                        break;
    ...
    {
        function.Write(OpFactory.Reference(identifier.Ident), new Metadata {Ast = identifier});
    }

    public void Visit(AstIx ix, Function function, Module mod)
    {
        function.Write(OpFactory.Reference($".ix{ForDepth}"), new Metadata {Ast = ix});
    }
    ...
    public void Visit(AstForArray forArray, Function function, Module mod)
    {
        ...
        function.Write(OpFactory.CallMember("len", argumentCount: 0), new Metadata {Ast = forArray});
        ...
        function.Write(OpFactory.Reference($".ix{ForDepth}"), new Metadata {Ast = forArray});
        ...
        function.Write(OpFactory.TypeGet(), new Metadata {Ast = forArray});
        function.Write(OpFactory.Reference($".ix{ForDepth}"), new Metadata {Ast = forArray});
        function.Write(OpFactory.CallMember("idx_get", argumentCount: 1), new Metadata {Ast = forArray});
    ...
    public void Visit(AstForRange forRange, Function function, Module mod)
    {
        ...
        function.Write(OpFactory.Reference($".ix{ForDepth}"), new Metadata {Ast = forRange});
        var addressOfCmp = function.Code.Count - 1;
        forRange.Range.End.Accept(this, function, mod);
        if (forRange.Reversed)
            function.Write(OpFactory.LessThan(), new Metadata {Ast = forRange});
    ...
    {
        function.Write(OpFactory.Reference(SpecialVariables.Me), new Metadata {Ast = me});
    }
    ...
    public void Visit(AstUse astUse, Function function, Module mod)
    {
        ...
        function.Write(OpFactory.Reference(astUse.Identifier));
    ...
    {
        function.Write(OpFactory.Reference($".it{ForDepth}"), new Metadata {Ast = it});
    }
    ...
    {
        function.Write(OpFactory.MemberReference(memberReference.Ident),
    ...
    public void Visit(AstMemberFunctionCall memberFuncCall, Function function, Module mod)
    {
        ...
        function.Write(OpFactory.CallMember(memberFuncCall.Ident, argumentCount: memberFuncCall.Arguments.Count),
            new Metadata {Ast = memberFuncCall});
    }

    public void Visit(AstMemberIndexerRef indexer, Function function, Module mod)
    {
        function.Write(OpFactory.MemberReference(indexer.Ident), new Metadata {Ast = indexer});
        function.Write(OpFactory.TypeGet(), new Metadata {Ast = indexer});
        indexer.IndexExprs[0].Accept(this, function, mod);
        function.Write(OpFactory.CallMember("idx_get", argumentCount: 1),
